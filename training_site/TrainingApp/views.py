...
def index(req):
    if req.method == 'POST':
        ...
        predictor_path = ('TrainingApp/static/shape_predictor_68_face_landmarks.dat')
    ...
    return render(req, 'TrainingApp/index.html', context)
...
def imageview(req, control_id, filename):
    ...
    return render(req, 'TrainingApp/components/imageview.html', context)
